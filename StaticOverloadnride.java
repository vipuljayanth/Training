    ...
    public class StaticOverloadnride {
        ...
        public static void main(String[] args) {
            StaticOverloadnride obj = new StaticOverloadnride();
            StaticOverloadnride obj1 = new StaticOverloadnride();
            obj.a = 2;
            obj.noOfObjects = 6;
            System.out.println(noOfObjects);
            ...
            System.out.println(StaticOverloadnride.noOfObjects);
            fun();
            obj.fun();
            StaticOverloadnride.fun();
